...
socket.onmessage = function(event) {
    ...
    // Если ключ 'UserList' то выводим из jsona список пользователя
    if ('UserList' in data) {
...
function userLogged(userId) {
    // удалим уже ненужный div выбора пользователя если он был выбран
...
// Запрос данных с сервера пользователя + комнат
...
// Выгрузка на сервер аватара пользователя
